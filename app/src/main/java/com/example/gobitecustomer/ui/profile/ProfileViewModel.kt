...
import com.example.gobitecustomer.data.model.Responsesd
...
class ProfileViewModel(private val userRepository: UserRepository, private val placeRepository: PlaceRepository,
    ...
    //Update User Details
    private val performUpdate = MutableLiveData<Resource<Responsesd<String>>>()
    val performUpdateStatus: LiveData<Resource<Responsesd<String>>>
        get() = performUpdate
