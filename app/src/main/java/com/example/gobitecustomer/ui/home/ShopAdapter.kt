...
class ShopAdapter(private val context: Context, private val shopList: List<shops>, private val listener: OnItemClickListener) : RecyclerView.Adapter<ShopViewHolder>() {
